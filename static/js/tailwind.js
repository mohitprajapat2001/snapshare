 ...
 * Original file: /npm/@tailwindcss/browser@4.0.15/dist/index.global.js
 *
...
(() => {
    ...
    function t(t) {
        ...
        for (let f = 0; f < t.length; f++) {
            ...
            if (92 === h) (u += t.slice(f, f + 2)), (f += 1);
                ...
                for (let n = f + 1; n < t.length; n++)
                    if (((o = t.charCodeAt(n)), 92 === o)) n += 1;
                        ...
                        if (59 === o && t.charCodeAt(n + 1) === e)
                            throw new Error(
                                `Unterminated string: ${t.slice(r, n + 1) + String.fromCharCode(h)
                                }`
                            );
                        if (o === e)
                            throw new Error(
                                `Unterminated string: ${t.slice(r, n) + String.fromCharCode(h)}`
                            );
                    }
                u += t.slice(r, f + 1);
            } else {
                ...
                } else if (59 === h && 64 === u.charCodeAt(0))
                    (c = r(u)), s ? s.nodes.push(c) : i.push(c), (u = ""), (c = null);
    ...
    function h(e, t, r = null) {
        for (let n = 0; n < e.length; n++) {
            ...
            if (i) 0 === a ? n-- : (n += l - 1);
                ...
                if (2 === a) return 2;
                if (1 !== a && "function" === o.kind && 2 === h(o.nodes, t, o))
                    return 2;
            }
        }
    }
    ...
    function C(e, t, r = [], n = {}) {
        for (let o = 0; o < e.length; o++) {
            ...
            if ("rule" === i.kind || "at-rule" === i.kind)
                r.push(i), C(i.nodes, t, r, n), r.pop();
    ...
    function T(e, t) {
        ...
        function s(e, c, u = {}, d = 0) {
            if ("declaration" === e.kind) {
                ...
                let t = { ...e, nodes: [] };
                for (let r of e.nodes) s(r, t.nodes, u, d + 1);
                "@keyframes" === e.name && u.theme && i.add(t),
                    (t.nodes.length > 0 ||
                        "@layer" === t.name ||
                        "@charset" === t.name ||
                        "@custom-media" === t.name ||
    ...
    function F(e) {
        ...
        return (
            ...
            (e = (function (e) {
                ...
                let t = !1;
                V.some((t) => e.includes(t)) &&
                    ((N.lastIndex = 0),
                        (e = e.replace(N, (e, r) => ((t = !0), `$${V.indexOf(r)}$(`))));
                let r = "",
                    n = [];
    ...
    function L(e) {
        if ("[" === e[0] && "]" === e[e.length - 1]) {
            let t = F(e.slice(1, -1));
            return 0 === t.length || 0 === t.trim().length
                ? null
    ...
    var P = {
        ...
        "bg-size": function (e) {
            ...
            for (let r of B(e, ",")) {
                ...
                e.every((e) => "auto" === e || ie(e) || re(e)) && (t += 1);
            }
            return t > 0;
        },
        "line-width": function (e) {
            return B(e, " ").every(
                (e) => ie(e) || ee(e) || "thin" === e || "medium" === e || "thick" === e
            );
        },
        image: function (e) {
            let t = 0;
    ...
    var G = /^(?:element|image|cross-fade|image-set)\(/,
        X = /^(repeating-)?(conic|linear|radial)-gradient\(/;
    var J = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/,
        Q = new RegExp(`^${J.source}$`);
    function ee(e) {
        return Q.test(e) || O(e);
    }
    var te = new RegExp(`^${J.source}%$`);
    function re(e) {
        return te.test(e) || O(e);
    }
    var ne = new RegExp(`^${J.source}s*/s*${J.source}$`);
    var oe = new RegExp(
        `^${J.source}(${[
            "cm",
            "mm",
    ...
    function ie(e) {
        return oe.test(e) || O(e);
    }
    var le = new RegExp(
        `^${J.source}(${["deg", "rad", "grad", "turn"].join("|")})$`
    );
    var ae = new RegExp(`^${J.source} +${J.source} +${J.source}$`);
    function se(e) {
        let t = Number(e);
    ...
    var he = new Set(["inset", "inherit", "initial", "revert", "unset"]),
        pe = /^-?(\d+|\.\d+)(.*?)$/g;
    function me(e, t) {
        return B(e, ",")
            .map((e) => {
                let r = B((e = e.trim()), " ").filter((e) => "" !== e.trim()),
                    n = null,
                    o = null,
                    i = null;
                for (let e of r)
    ...
    function ye(e, t, r) {
        if (!t) return e;
        if ("arbitrary" === t.kind) return ke(e, t.value);
        let n = r.resolve(t.value, ["--opacity"]);
        return n ? ke(e, n) : de(t.value) ? ke(e, `${t.value}%`) : null;
    }
    function xe(e, t, r) {
        let n = null;
        ...
        return n ? ye(n, e.modifier, t) : null;
    }
    function $e(e, t, r) {
        for (let n of t.nodes)
            if (
                ...
                if ("named" === e.kind && "word" === n.kind) {
                    ...
                    if ("ratio" === r) {
                        let [e, r] = B(t, "/");
                        if (!se(e) || !se(r)) continue;
                    } else {
                        if ("number" === r && !ue(t)) continue;
                        if ("percentage" === r && !se(t.slice(0, -1))) continue;
                    }
    ...
    var Ae = {
        "--alpha": function (e, t, r, ...n) {
            let [o, i] = B(r, "/").map((e) => e.trim());
            if (!o || !i)
                throw new Error(
                    `The --alpha(…) function requires a color and an alpha value, e.g.: \`--alpha(${o || "var(--my-color)"
                    } / ${i || "50%"})\``
                );
            if (n.length > 0)
                throw new Error(
                    `The --alpha(…) function only accepts one argument, e.g.: \`--alpha(${o || "var(--my-color)"
                    } / ${i || "50%"})\``
                );
            return ke(o, i);
        },
    ...
    function Ce(e, t) {
        ...
        return (
            z(e, (e) => {
                if ("declaration" === e.kind && e.value && ze.test(e.value))
                    return (r |= 8), void (e.value = Te(e.value, e, t));
                "at-rule" === e.kind &&
                    ("@media" === e.name ||
                        "@custom-media" === e.name ||
                        "@container" === e.name ||
    ...
    function Te(e, t, r) {
        ...
        return (
            h(n, (e, { replaceWith: n }) => {
                if ("function" === e.kind && e.value in Ae) {
                    let o = B(p(e.nodes).trim(), ",").map((e) => e.trim());
                    return n(m(Ae[e.value](r, t, ...o)));
                }
            }),
            p(n)
        );
        ...
        for (let r of e.utilities.keys("functional")) {
            ...
            for (let e of n)
                for (let n of e.values) {
                    let o = null !== n && Ke.test(n),
                        i = null === n ? r : `${r}-${n}`;
                    t.push({ name: i, utility: r, fraction: o, modifiers: e.modifiers }),
                        e.supportsNegative &&
                        t.push({
                            name: `-${i}`,
                            utility: `-${r}`,
                ...
                (function (e) {
                    ...
                    for (let i of e) {
                        ...
                        r || ((r = { utility: e, items: [] }), n.set(e, r)),
                            ...
                            l ? o.get(e).push(i) : r.items.push(i);
                    }
    ...
    var Ee = /^@?[a-zA-Z0-9_-]*$/,
        Ve = class {
            ...
            compare(e, t) {
                ...
                return null === i
                    ? -1
                    : null === l || ("arbitrary" === i.kind && "arbitrary" !== l.kind)
                        ? 1
                        : ("arbitrary" !== i.kind && "arbitrary" === l.kind) ||
                            i.value < l.value
                            ? -1
                            : 1;
            }
            ...
            set(
                ...
                l
                    ? Object.assign(l, { kind: t, applyFn: r, compounds: n })
                    : (void 0 === i &&
    ...
    function Fe(e, t) {
        z(e, (e, { replaceWith: r }) => {
            if ("at-rule" === e.kind && "@slot" === e.name) r(t);
                ...
                return Object.assign(e, A([w(e.name, e.params, e.nodes)])), 1;
        });
    }
    function We(e) {
        let t = (function (e) {
                ...
                t.functional(n, (t) => {
                    ...
                    return (
                        "arbitrary" === t.value.kind
                            ? ((r = t.value.value), (r = ye(r, t.modifier, e)))
                            : (r = xe(t, e, o.themeKeys)),
            ...
            function l(
                ...
                i,
                l,
                { supportsNegative: a = !1, supportsFractions: s = !1 } = {}
            ) {
                a && t.static(`-${n}-px`, () => l("-1px")),
                    t.static(`${n}-px`, () => l("1px")),
                    o(n, {
                        themeKeys: i,
                        supportsFractions: s,
            ...
            n("isolate", [["isolation", "isolate"]]),
                ...
                o("z", {
                    supportsNegative: !0,
                    handleBareValue: ({ value: e }) => (se(e) ? e : null),
                    themeKeys: ["--z-index"],
            ...
            for (let [e, t, r] of [
                ...
                l(e, t, (e) => [y(r, e)], { supportsFractions: !0 });
            t.static("container", () => {
                ...
                for (let e of t)
                    r.push(w("@media", `(width >= ${e})`, [y("max-width", e)]));
                return r;
            }),
            ...
            l("border-spacing", ["--border-spacing", "--spacing"], (e) => [
                a(),
                ...
                l("border-spacing-x", ["--border-spacing", "--spacing"], (e) => [
                    a(),
                    y("--tw-border-spacing-x", e),
                    y(
                        "border-spacing",
                ...
                l("border-spacing-y", ["--border-spacing", "--spacing"], (e) => [
                    a(),
                    y("--tw-border-spacing-y", e),
                    y(
                        "border-spacing",
                ...
                return (r) => {
                    ...
                    return "arbitrary" === r.value.kind
                        ...
                        : ((n = e.resolve(r.value.value, ["--scale"])),
                            !n && se(r.value.value) && (n = `${r.value.value}%`),
                            n
                                ? ((n = t ? `calc(${n} * -1)` : n),
                                    [
                                        c(),
                ...
                return (r) => {
                    ...
                    if ("arbitrary" === r.value.kind) {
                        ...
                        ((n = e.resolve(r.value.value, ["--rotate"])),
                            !n && se(r.value.value) && (n = `${r.value.value}deg`),
                            !n)
                    )
                        return;
                ...
                ]);
            {
                let e = [
                    ...
                    i = () =>
                        A([
                            we("--tw-rotate-x", "rotateX(0)"),
                            we("--tw-rotate-y", "rotateY(0)"),
                            we("--tw-rotate-z", "rotateZ(0)"),
                            we("--tw-skew-x", "skewX(0)"),
                            we("--tw-skew-y", "skewY(0)"),
                        ]);
                for (let t of ["x", "y", "z"])
                    o(`rotate-${t}`, {
                        supportsNegative: !0,
                        themeKeys: ["--rotate"],
                        handleBareValue: ({ value: e }) => (se(e) ? `${e}deg` : null),
                        handle: (r) => [
                            i(),
            ...
            let f = () =>
                A([we("--tw-pan-x"), we("--tw-pan-y"), we("--tw-pinch-zoom")]);
            ...
            let h = () => A([we("--tw-scroll-snap-strictness", "proximity", "*")]);
            for (let e of ["x", "y", "both"])
                n(`snap-${e}`, [
                    h,
                    ["scroll-snap-type", `${e} var(--tw-scroll-snap-strictness)`],
                ]);
            n("snap-mandatory", [h, ["--tw-scroll-snap-strictness", "mandatory"]]),
                n("snap-proximity", [
                    h,
            ...
            n("grid-flow-row", [["grid-auto-flow", "row"]]),
                ...
                o("grid-cols", {
                    ...
                    handleBareValue: ({ value: e }) =>
                        ce(e) ? `repeat(${e}, minmax(0, 1fr))` : null,
                ...
                l("gap", ["--gap", "--spacing"], (e) => [y("gap", e)]),
                l("gap-x", ["--gap", "--spacing"], (e) => [y("column-gap", e)]),
                l("gap-y", ["--gap", "--spacing"], (e) => [y("row-gap", e)]),
                l(
                    "space-x",
                    ["--space", "--spacing"],
                    (e) => [
                        A([we("--tw-space-x-reverse", "0")]),
                ...
                ]);
            {
                let i = function (n, o) {
                    t.functional(n, (t) => {
                        ...
                        {
                            let r = xe(t, e, ["--border-color", "--color"]);
                ...
                i("border", {
                    ...
                    o("divide-x", {
                        ...
                        handleBareValue: ({ value: e }) => (se(e) ? `${e}px` : null),
                        handle: (e) => [
                            A([we("--tw-divide-x-reverse", "0")]),
                            b(":where(& > :not(:last-child))", [
            ...
            n("bg-auto", [["background-size", "auto"]]),
                ...
                n("bg-right-top", [["background-position", "right top"]]),
                n("bg-right", [["background-position", "right"]]),
                n("bg-right-bottom", [["background-position", "right bottom"]]),
                n("bg-bottom", [["background-position", "bottom"]]),
                n("bg-left-bottom", [["background-position", "left bottom"]]),
                n("bg-left", [["background-position", "left"]]),
                n("bg-left-top", [["background-position", "left top"]]),
                    ...
                    n = function ({ negative: t }) {
                        return (r) => {
                            ...
                            if ("arbitrary" === r.value.kind) {
                                if (r.modifier) return;
                                let e = r.value.value;
                                return "angle" === (r.value.dataType ?? H(e, ["angle"]))
                                    ? ((e = t ? `calc(${e} * -1)` : `${e}`),
                                        [
                            ...
                            return [
                                y("--tw-gradient-position", `${n} ${e(r.modifier)}`),
                                y(
                                    "background-image",
            ...
            t.functional("bg", (t) => {
                if (t.value) {
                    ...
                    {
                        let r = xe(t, e, ["--background-color", "--color"]);
            ...
            n("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]),
                ...
                t.functional("fill", (t) => {
                    if (!t.value) return;
                    if ("arbitrary" === t.value.kind) {
                        let r = ye(t.value.value, t.modifier, e);
                        return null === r ? void 0 : [y("fill", r)];
                    }
                    let r = xe(t, e, ["--fill", "--color"]);
                ...
                t.functional("stroke", (t) => {
                    if (t.value) {
                        if ("arbitrary" === t.value.kind) {
                            ...
                            switch (
                            t.value.dataType ??
                            H(r, ["color", "number", "length", "percentage"])
                            ) {
                                case "number":
                                case "length":
                                case "percentage":
                                ...
                                default:
                                    return (
                                        (r = ye(t.value.value, t.modifier, e)),
                                        null === r ? void 0 : [y("stroke", r)]
                                    );
                            }
                        }
                        {
                            let r = xe(t, e, ["--stroke", "--color"]);
                ...
                n("object-left-bottom", [["object-position", "left bottom"]]),
                n("object-left-top", [["object-position", "left top"]]),
                n("object-right", [["object-position", "right"]]),
                n("object-right-bottom", [["object-position", "right bottom"]]),
                n("object-right-top", [["object-position", "right top"]]),
            ...
            n("text-left", [["text-align", "left"]]),
                ...
                t.functional("font", (t) => {
                    if (t.value && !t.modifier) {
                        if ("arbitrary" === t.value.kind) {
                            ...
                            switch (
                            t.value.dataType ??
                            H(e, ["number", "generic-name", "family-name"])
                            ) {
                                case "generic-name":
                                case "family-name":
                ...
                o("font-stretch", {
                    handleBareValue: ({ value: e }) => {
                        ...
                        return !se(t) || Number.isNaN(t) || t < 50 || t > 200 ? null : e;
                    },
                ...
                t.functional("decoration", (t) => {
                    if (t.value) {
                        ...
                        {
                            let r = xe(t, e, ["--text-decoration-color", "--color"]);
                ...
                });
            {
                ...
                t.functional("filter", (t) => {
                    ...
                    n("blur-none", [l, ["--tw-blur", " "], ["filter", e]]),
                    o("backdrop-blur", {
            ...
            {
                let i = `var(--tw-ease, ${e.resolve(null, ["--default-transition-timing-function"]) ??
                    "ease"
                    })`,
                ...
                n("transition-none", [["transition-property", "none"]]),
                    ...
                    o("delay", {
                        handleBareValue: ({ value: e }) => (se(e) ? `${e}ms` : null),
                        themeKeys: ["--transition-delay"],
                        handle: (e) => [y("transition-delay", e)],
                    });
                {
                    let r = () => A([we("--tw-duration")]);
            ...
            {
                let i = () => A([we("--tw-outline-style", "solid")]);
                t.static("outline-hidden", () => [
                    ...
                    t.functional("outline", (t) => {
                        ...
                        if ("arbitrary" === t.value.kind) {
                            ...
                            switch (
                            t.value.dataType ??
                            H(r, ["color", "length", "number", "percentage"])
                            ) {
                                case "length":
                                case "number":
                                case "percentage":
                        ...
                        {
                            let r = xe(t, e, ["--outline-color", "--color"]);
                ...
                ]);
            {
                ...
                n("shadow-initial", [s, ["--tw-shadow-color", "initial"]]),
                    t.functional("shadow", (t) => {
                        ...
                        if ("arbitrary" === t.value.kind) {
                            let r = t.value.value;
                            return "color" === (t.value.dataType ?? H(r, ["color"]))
                                ? ((r = ye(r, t.modifier, e)),
                                    null === r ? void 0 : [s(), y("--tw-shadow-color", r)])
                                : [
                                    s(),
                                    y(
                                        "--tw-shadow",
                                        me(r, (e) => `var(--tw-shadow-color, ${e})`)
                                    ),
                                    y("box-shadow", l),
                                ];
                        }
                        if ("none" === t.value.value)
                            return t.modifier
                                ? void 0
                                : [s(), y("--tw-shadow", a), y("box-shadow", l)];
                        {
                        ...
                        {
                            let r = xe(t, e, ["--box-shadow-color", "--color"]);
                    ...
                    t.functional("inset-shadow", (t) => {
                        if (!t.value) {
                            ...
                            return null === t
                                ...
                                : [
                                    ...
                                    y(
                                        "--tw-inset-shadow",
                                        me(t, (e) => `var(--tw-inset-shadow-color, ${e})`)
                                    ),
                                    y("box-shadow", l),
                                ];
                        }
                        ...
                        if ("none" === t.value.value)
                            return t.modifier
                                ? void 0
                                : [s(), y("--tw-inset-shadow", a), y("box-shadow", l)];
                        {
                            ...
                            if (r)
                                return t.modifier
                                    ...
                                    : [
                                        ...
                                        y(
                                            "--tw-inset-shadow",
                                            me(r, (e) => `var(--tw-inset-shadow-color, ${e})`)
                                        ),
                                        y("box-shadow", l),
                                    ];
                        }
                ...
                t.functional("ring", (t) => {
                    ...
                    if ("arbitrary" === t.value.kind) {
                        let r = t.value.value;
                        return "length" ===
                            (t.value.dataType ?? H(r, ["color", "length"]))
                            ? t.modifier
                                ? void 0
                                : [s(), y("--tw-ring-shadow", o(r)), y("box-shadow", l)]
                            : ((r = ye(r, t.modifier, e)),
                                null === r ? void 0 : [y("--tw-ring-color", r)]);
                    }
                    {
                        let r = xe(t, e, ["--ring-color", "--color"]);
                    ...
                    }
                    {
                        ...
                        if (
                            (null === r && se(t.value.value) && (r = `${t.value.value}px`),
                                r)
                        )
                            return [s(), y("--tw-ring-shadow", o(r)), y("box-shadow", l)];
                    }
                ...
                t.functional("ring-offset", (t) => {
                    if (t.value) {
                        ...
                        {
                            let r = xe(t, e, ["--ring-offset-color", "--color"]);
            ...
            r = (function (e) {
                ...
                r("first", ["&:first-child"]),
                    ...
                    t.functional("aria", (e, t) => {
                        ...
                        "arbitrary" === t.value.kind
                            ? (e.nodes = [b(`&[aria-${Oe(t.value.value)}]`, e.nodes)])
                            : (e.nodes = [b(`&[aria-${t.value.value}="true"]`, e.nodes)]);
                    }),
                    t.suggest("aria", () => [
                        "busy",
                        "checked",
                    ...
                    t.functional("nth", (e, t) => {
                        if (
                            !t.value ||
                            t.modifier ||
                            ("named" === t.value.kind && !se(t.value.value))
                        )
                            return null;
                            ...
                            switch (t.variants.kind(e)) {
                                ...
                                case "functional": {
                                    ...
                                    if ("]" === r[r.length - 1]) {
                                        if ("[" !== r[0]) continue;
                                        let n = F(r.slice(1, -1));
                                        return 0 === n.length || 0 === n.trim().length
                                            ? null
                                            : {
                                                kind: "functional",
                                                root: e,
                                    ...
                                    if (null !== r) {
                                        {
                                            ...
                                            if (-1 !== e) {
                                                ...
                                                let e =
                                                    null === a || "arbitrary" === n.modifier?.kind
                                                        ? null
                                                        : `${r}/${a}`;
                ...
                let t = (function (e, t) {
                    let r = (function (e, t) {
                        if ("arbitrary" === e.kind) {
                            let r = e.value;
                            return (
                                e.modifier && (r = ye(r, e.modifier, t.theme)),
                    ...
                    for (let o of r) {
                        ...
                        for (let r of e.variants)
                            if (null === _e(l, r, t.variants)) return [];
            ...
            s = {
                ...
                getClassOrder(e) {
                    return (function (e, t) {
                        let { astNodes: r, nodeSorting: n } = De(Array.from(t), e),
    ...
    function _e(e, t, r, n = 0) {
        if ("arbitrary" === t.kind)
            return t.relative && 0 === n
                ? null
                : void (e.nodes = [k(t.selector, e.nodes)]);
        let { applyFn: o } = r.get(t.root);
        if ("compound" === t.kind) {
            let i = w("@slot");
            if (
                null === _e(i, t.variant, r, n + 1) ||
    ...
    function Le(e) {
        for (let t of e)
            "at-root" !== t.kind &&
                ("declaration" === t.kind
                    ? (t.important = !0)
                    : ("rule" === t.kind || "at-rule" === t.kind) && Le(t.nodes));
    }
    function Me(e) {
        let t = new Set(),
            r = 0,
        ...
        for (; n.length > 0;) {
            ...
            if ("declaration" === e.kind) {
                ...
                if ("--tw-sort" === e.property) {
                    let r = Ue.indexOf(e.value ?? "");
                    if (-1 !== r) {
                        t.add(r), (o = !0);
                        continue;
                    }
                }
                let n = Ue.indexOf(e.property);
                -1 !== n && t.add(n);
                    ...
                    let s = (function (e) {
                        ...
                        for (let i = 0; i < e.length; i++) {
                            ...
                            if ("separator" !== l.kind) {
                                ...
                                if (
                                    ("function" === l.kind && "url" === l.value.toLowerCase()) ||
                                    !t
                                )
                                    return null;
                                if (
                                    ("word" === l.kind || "function" === l.kind) &&
                                    "layer" === l.value.toLowerCase()
                                ) {
                                    if (r) return null;
                                    if (o)
                                        throw new Error(
                    ...
                    return (
                        l.push(
                            (async () => {
                                ...
                                let e = await n(c, r),
                                    i = t(e.content);
                                await qe(i, e.base, n, o + 1),
                                    (h.nodes = (function (e, t, r, n) {
                                        let o = e;
                                        return (
                                            null !== t && (o = [w("@layer", t, o)]),
                                            null !== r && (o = [w("@media", r, o)]),
                                            null !== n &&
                                            (o = [w("@supports", "(" === n[0] ? n : `(${n})`, o)]),
                                            o
                                        );
                                    })([$({ base: e.base }, i)], u, d, f));
                            })()
                ...
                n &&
                    ...
                    (e.theme.add("--default-font-family", n, r),
                        e.theme.add(
                            ...
                            Pe(t.fontFamily.sans, "fontFeatureSettings") ?? "normal",
                            r
                        ),
                        e.theme.add(
                            "--default-font-variation-settings",
                            Pe(t.fontFamily.sans, "fontVariationSettings") ?? "normal",
                            r
                        ));
            }
            {
                ...
                n &&
                    ...
                    (e.theme.add("--default-mono-font-family", n, r),
                        e.theme.add(
                            ...
                            Pe(t.fontFamily.mono, "fontFeatureSettings") ?? "normal",
                            r
                        ),
                        e.theme.add(
                            "--default-mono-font-variation-settings",
                            Pe(t.fontFamily.mono, "fontVariationSettings") ?? "normal",
                            r
                        ));
            }
        }
    ...
    function Ge(e, t = [], r) {
        for (let n of Reflect.ownKeys(e)) {
            ...
            if (1 !== l) {
                if (2 === l) return 2;
                if ((Array.isArray(o) || "object" == typeof o) && 2 === Ge(o, i, r))
                    return 2;
            }
        }
    }
        ...
        return function (n, o) {
            ...
            let s = (() => {
                ...
                if (
                    ...
                    return "object" != typeof a && 4 & a ? s ?? l : l;
                if (null !== s && "object" == typeof s && !Array.isArray(s)) {
                    ...
                    for (let t in l)
                        "__CSS_VALUES__" !== t &&
                            ((4 & s?.__CSS_VALUES__?.[t] && void 0 !== tt(e, t.split("-"))) ||
                                (e[i(t)] = l[t]));
                    return e;
                }
            ...
            return a && "string" == typeof s && (s = ke(s, a)), s ?? o;
        };
    }
    function tt(e, t) {
    ...
    function st(e, t, r = null) {
        for (let n = 0; n < e.length; n++) {
            ...
            if (i) 0 === a ? n-- : (n += l - 1);
                ...
                if (2 === a) return 2;
                if (1 !== a && "function" === o.kind && 2 === st(o.nodes, t, o))
                    return 2;
            }
        }
    }
            ...
            switch (a) {
                ...
                case 40: {
                    ...
                    if (
                        ...
                        let c = l;
                        a.nodes.push(at(e.slice(n, c))),
                            (i = ""),
                            (l = c),
                            o ? o.nodes.push(a) : r.push(a);
                        break;
                    }
            ...
            addVariant(t, r) {
                ...
                "string" == typeof r || Array.isArray(r)
                    ? e.variants.static(
                        ...
                        { compounds: Ne("string" == typeof r ? [r] : r) }
                    )
                    : "object" == typeof r && e.variants.fromAst(t, ht(r));
            },
            matchVariant(t, r, n) {
                function o(e, t, n) {
                ...
                e.variants.group(
                    ...
                    (e, t) => {
                        ...
                        if (n && "function" == typeof n.sort)
                            return n.sort(
                                { value: l, modifier: e.modifier?.value ?? null },
            ...
            matchUtilities(t, r) {
                ...
                for (let [i, l] of Object.entries(t)) {
                    let t = function ({ negative: t }) {
                        return (a) => {
                            if (
                                "arbitrary" === a.value?.kind &&
                                o.length > 0 &&
                                !o.includes("any") &&
                                ((a.value.dataType && !o.includes(a.value.dataType)) ||
                                    (!a.value.dataType && !H(a.value.value, o)))
                            )
                                return;
                            let s,
                                c = o.includes("color"),
                                ...
                                d = !1;
                            {
                                ...
                                c &&
                                    ...
                                    a.value
                                        ? "arbitrary" === a.value.kind
                                            ? (u = a.value.value)
                                            : a.value.fraction && e[a.value.fraction]
                                                ? ((u = e[a.value.fraction]), (d = !0))
                                                : e[a.value.value]
                                                    ? (u = e[a.value.value])
                                                    : e.__BARE_VALUE__ &&
                                                    ((u = e.__BARE_VALUE__(a.value) ?? null),
                                                        (d =
                                                            (null !== a.value.fraction && u?.includes("/")) ??
                                                            !1))
                                        : (u = e.DEFAULT ?? null);
                            }
                            if (null === u) return;
                            {
                                ...
                                s = a.modifier
                                    ? "any" === e || "arbitrary" === a.modifier.kind
                                        ? a.modifier.value
                                        : e?.[a.modifier.value]
                                            ? e[a.modifier.value]
                                            : c && !Number.isNaN(Number(a.modifier.value))
                                                ? `${a.modifier.value}%`
                                                : null
                                    : null;
                            }
                            if (a.modifier && null === s && !d)
                                return "arbitrary" === a.value?.kind ? null : void 0;
                            c && null !== s && (u = ke(u, s)), t && (u = `calc(${u} * -1)`);
    ...
    function ht(e) {
        ...
        for (let [e, n] of r)
            if ("object" != typeof n) {
                ...
                for (let r of n)
                    "string" == typeof r ? t.push(y(e, r)) : t.push(k(e, ht(r)));
            else null !== n && t.push(k(e, ht(n)));
        return t;
    }
    function pt(e, r) {
    ...
    var wt = bt((e) => {
        if (se(e.value)) return e.value;
    }),
        kt = bt((e) => {
            if (se(e.value)) return `${e.value}%`;
        }),
        yt = bt((e) => {
            if (se(e.value)) return `${e.value}px`;
        }),
        xt = bt((e) => {
            if (se(e.value)) return `${e.value}ms`;
        }),
        $t = bt((e) => {
            if (se(e.value)) return `${e.value}deg`;
        }),
        At = bt((e) => {
            if (null === e.fraction) return;
            let [t, r] = B(e.fraction, "/");
            return se(t) && se(r) ? e.fraction : void 0;
        }),
        zt = bt((e) => {
            if (se(Number(e.value))) return `repeat(${e.value}, minmax(0, 1fr))`;
        }),
        Ct = {
    ...
    function Kt(e, t) {
        ...
        let n = (function (e) {
            let t = new Set(),
                ...
                n = Object.assign(r, { theme: r, colors: vt });
            function o(e) {
    ...
    function St(e, t) {
        return Array.isArray(e) && Je(e[0])
            ? e.concat(t)
            : Array.isArray(t) && Je(t[0]) && Je(e)
                ? [e, ...t]
                : Array.isArray(t)
                    ? t
                    : void 0;
    ...
    function Et(e, { config: t, base: r, path: n, reference: o }) {
        ...
        for (let i of t.presets ?? [])
            Et(e, { path: n, base: r, config: i, reference: o });
        for (let t of i)
            e.plugins.push(t),
                t.config &&
                Et(e, {
        ...
        let n = (function ({ center: e, padding: t, screens: r }, n) {
            ...
            if (
                ...
                if ((e.sort((e, t) => R(e[1], t[1], "asc")), e.length > 0)) {
                    let [t] = e[0];
                    o.push(
                        w("@media", `(width >= --theme(--breakpoint-${t}))`, [
                            y("max-width", "none"),
                        ])
                    );
                }
                ...
                if ("@plugin" === e.name) {
                    ...
                    for (let t of e.nodes ?? []) {
                        ...
                        let e = B(t.value, ",").map((e) => {
                            ...
                            if ("{" === e[0] && "}" === e[e.length - 1])
                                throw new Error(
                                    `Unexpected \`@plugin\` option: Value of declaration \`${j([
                                        t,
                ...
                e.utilities.functional("max-w-screen", (t) => {
                    ...
                    e.utilities.functional("flex-shrink", (e) => {
                        if (!e.modifier) {
                            ...
                            if (se(e.value.value)) return [y("flex-shrink", e.value.value)];
                        }
                    }),
                    e.utilities.functional("flex-grow", (e) => {
                        if (!e.modifier) {
                            ...
                            if (se(e.value.value)) return [y("flex-grow", e.value.value)];
                        }
                    });
            })(e);
        let s = e.resolveThemeValue;
        if (
            ((e.resolveThemeValue = function (n, l) {
                return n.startsWith("--")
                    ? s(n, l)
                    : ((i |= Ut({
                        designSystem: e,
    ...
    function Ut({
        ...
        let l = 0,
            ...
            { resolvedConfig: s } = Kt(e, [
                { config: Tt(e.theme), base: t, reference: !0 },
                ...a,
                { config: { plugins: [Nt] }, base: t, reference: !0 },
            ]),
            { resolvedConfig: c, replacedThemeKeys: u } = Kt(e, a);
        ...
        for (let { handler: e, reference: t } of s.plugins)
            t ? ((d ||= ft({ ...f, referenceMode: !0 })), e(d)) : e(h);
        if (
            (He(e, c, u),
                gt(e, c),
                (function (e, t) {
        ...
        if (
            ...
            z(r, (t, { replaceWith: r, parent: n }) => {
                if (
                    ...
                    return ("rule" === n?.kind && n.selector === e) || r(b(e, [t])), 2;
            });
        }
    ...
    async function Lt(
        e,
        { base: t = "", loadModule: r = _t, loadStylesheet: n = Bt } = {}
    ) {
        let l = 0;
                    ...
                    return (
                        z(e.nodes, (r) => {
                            ...
                            if ("declaration" === r.kind && r.property.startsWith("--"))
                                return void c.add(i(r.property), r.value ?? "", t);
                            let n = j([w(e.name, e.params, [r])])
                                .split("\n")
                                .map(
                                    (e, t, r) =>
                                        `${0 === t || t >= r.length - 2 ? " " : ">"} ${e}`
        ...
        let S = We(c);
        if ((a && (S.important = a), T.length > 0))
            for (let e of T) S.invalidCandidates.add(e);
        l |= await Wt({
            designSystem: S,
            base: t,
            ast: e,
        ...
        if (f) {
            let t = [];
            for (let [e, r] of S.theme.entries())
    ...
    async function Mt(e, r = {}) {
        let n = t(e),
            o = await (async function (e, t = {}) {
                ...
                n.unshift(
                    x("! tailwindcss v4.0.15 | MIT License | https://tailwindcss.com ")
                );
                let u = new Set(),
                    d = null,
                    f = 0,
                ...
                return {
                    ...
                    build(t) {
                        ...
                        let p = De(u, r, { onInvalidCandidate: c }).astNodes;
                        return i || f !== p.length
                            ? ((f = p.length), (l.nodes = p), (d = T(n, r)), d)
                            : ((d ??= T(n, r)), d);
                    },
                };
            })(n, r),
        ...
        try {
            let r = (function () {
                ...
                if (
                    ...
                    return { base: t, content: Rt.preflight };
                if (
                    "tailwindcss/theme" === e ||
                    "tailwindcss/theme.css" === e ||
                    "./theme.css" === e
                )
                    return { base: t, content: Rt.theme };
                if (
                    "tailwindcss/utilities" === e ||
                    "tailwindcss/utilities.css" === e ||
                    "./utilities.css" === e
                )
                    return { base: t, content: Rt.utilities };
                throw new Error(
                    `The browser build does not support @import for "${e}"`
                );
            })();
            return (
                Xt.hit("Loaded stylesheet", { id: e, base: t, size: r.content.length }),
                r
            );
        } catch (r) {
            throw (
                (Xt.hit("Failed to load stylesheet", {
                    id: e,
                    base: t,
                    error: r.message ?? r,
                }),
            ...
            Xt.start(`Build #${t} (${e})`),
                ...
                await (async function (e) {
                    ...
                    for (let e of document.querySelectorAll("[class]"))
                        for (let r of e.classList) Pt.has(r) || (Pt.add(r), t.add(r));
                    Xt.end("Collect classes", { count: t.size }),
                        (0 !== t.size || "incremental" !== e) &&
                        (Xt.start("Build utilities"),
                            (Yt.textContent = It.build(Array.from(t))),
                            Xt.end("Build utilities"));
                })(e),
                Xt.end("Build"),
                Xt.end(`Build #${t} (${e})`);
        }).catch((e) => Xt.error(e));
...
//# sourceMappingURL=/sm/01d01bf39e49a14d882da56bc3933ed5159e90c9e09040dd5670e87a92cc8c86.map
